...
try
    ...
    treeParams.nPosPatch =50; %50
    treeParams.nNegPatch = 500; %500
    ...
    [trees, treeParams] = forest_train(imagedir, trainNames,featureNames, trainPoints, featureParams, treeParams);
